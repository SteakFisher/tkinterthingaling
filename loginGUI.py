...
userNameLabel = tk.Label(window, text = 'Username', bg='#261C2C', fg='white', font = ('Norican', 50, 'normal')).place(x=screen_width * 0.2278, y=screen_height * 0.0381)
passwordLabel = tk.Label(window, text = 'Password', bg='#261C2C', fg='white', font = ('Norican', 50, 'normal')).place(x=screen_width * 0.537, y=screen_height * 0.0381)
